...
np.savez_compressed("data/10_10_million.dat", xinput=xinput, xwin_player1=xwin_player1, xdraw_player2=xdraw_player2) 
...
np.savez_compressed("data/NN_natural_10_10.dat", score=score, data1=data1, data2=data2, data3=data3)
