...
np.savez_compressed("data/4_4_million.dat", xinput=xinput, xwin_player1=xwin_player1, xdraw_player2=xdraw_player2) 
...
np.savez_compressed("data/NN_natural_4_4.dat", score=score, data1=data1, data2=data2, data3=data3)
